...
I_ipc = import("../../data/raw/2019-04-04/i_ipc.csv")
...
tab6b = import("../../data/raw/2019-04-04/tab6b.csv")
...
ind_prod = import("../../data/raw/2019-04-04/ind_okved2.csv")
...
invest = import("../../data/raw/2019-04-04/invest.csv")
...
the_forecasts = prepare_model_list2(h_all = h_all, model_fun_tibble = model_fun_tibble, series_data = invest_full_stable)
the_forecasts_new = estimate_and_forecast(the_forecasts)
