...
watchdog # built in data set in kassandr
...
export(download_log_new, paste0(path, "download_log.csv"))

# adding raw files to gitignore
write_lines(na.omit(watchdog$file_raw), file = paste0(path, ".gitignore"))
