...
I_ipc = import("../../data/raw/2020-06-15/i_ipc.csv")
...
tab6b = import("../../data/raw/2020-06-15/tab6b.csv")
...
ind_prod = import("../../data/raw/2020-06-15/ind_baza_2018.csv")
...
invest = import("../../data/raw/2020-06-15/invest.csv")
