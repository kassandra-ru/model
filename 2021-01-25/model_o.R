...
I_ipc = import("../../data/raw/2021-01-25/i_ipc.csv")
...
tab6b = import("../../data/raw/2021-01-25/tab6b.csv")
...
ind_prod = import("../../data/raw/2021-01-25/ind_baza_2018.csv")
...
invest = import("../../data/raw/2021-01-25/invest.csv")
