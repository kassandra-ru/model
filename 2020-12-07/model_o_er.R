...
# https://rosstat.gov.ru/storage/mediabank/a2Bf2bEU/i_ipc.xlsx
# http://rosstat.gov.ru/storage/mediabank/a2Bf2EU/i_ipc.xlsx

# cpi univariate models -------------------------------------------------------

start_date = ymd("2011-10-01")

I_ipc = import("../../data/raw/2020-12-08/i_ipc.csv")
...
cv_results_new = estimate_and_forecast(cv_results[-c(478, 502, 510, 514), ])
...
tab6b = import("../../data/raw/2020-12-07/tab6b.csv")
...
invest = import("../../data/raw/2020-12-07/invest.csv")
