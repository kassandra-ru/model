...
I_ipc = import("../../data/raw/2021-06-30/i_ipc.csv")
...
tab6b = import("../../data/raw/2021-06-30/tab6b.csv")
...
ind_prod = import("../../data/raw/2021-06-30/ind_baza_2018.csv")
ind_prod_tsibble = mutate(ind_prod[,c(1,2,4)], date = yearmonth(date)) %>% as_tsibble(index = date)%>%rename(value = ind_prod_perc_prev_month)
...
# 
# invest = import("../../data/raw/2021-06-30/invest.csv")
